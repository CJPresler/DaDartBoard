...
export const Dartboard = (props: DartboardProps) => {
  ...
  const getSegmentClassNames = useCallback(
    (shortName: string) => {
      return (
        "svgInteractive" +
        (gameState?.G.lastHit?.ShortName === shortName ? " hit" : "")
      );
    },
    [gameState?.G.lastHit]
  );
                ...
                <g id="areas">
                  ...
                  <g id="s">
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_19))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_14))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_4))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_16))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_9))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_7))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_8))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_12))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_1))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_18))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_20))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_5))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_3))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_10))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_17))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_13))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_2))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_6))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_11))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.INNER_15))
                      }
                  ...
                  <g id="d">
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_2))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_17))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_15))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_6))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_14))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_10))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_11))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_19))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_8))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_16))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_7))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_3))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_1))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_20))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_18))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_5))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_12))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_9))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_4))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_13))
                      }
                  ...
                  <g id="t">
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_10))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_13))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_3))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_2))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_8))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_14))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_7))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_9))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_4))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_17))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_15))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_18))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_20))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_5))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_1))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_12))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_6))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_11))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_19))
                      }
                    ...
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.TRP_16))
                      }
                  ...
                  <g id="bull">
                    <path
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.BULL))
                      }
                    ...
                    <circle
                      ...
                      onClick={() =>
                        onSegmentHit(CreateSegment(SegmentID.DBL_BULL))
                      }
                      cx="401.5"
                      cy="389"
                      r="13.7"
