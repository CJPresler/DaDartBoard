...
interface DartboardProps {
    ...
    boardColorAccent1?: string;
    boardColorAccent2?: string;
    borderGlow?: boolean;
    highlightSegmentShortName?: string;
    onSegmentClicked: (segment: Segment) => void;
}

export const Dartboard: FunctionComponent<DartboardProps> = (props: DartboardProps) => {
    const { boardColorDark, boardColorLight, boardColorAccent1, boardColorAccent2, borderGlow, onSegmentClicked } = props;

    const getSegmentClassNames = useCallback(
        (shortName: string) => {
            return (
                "svgInteractive" +
                (props.highlightSegmentShortName === shortName ? " hit" : "")
            );
        },
        [props.highlightSegmentShortName]
    );
            ...
            <g id="areas">
                <g id="miss">
                    ...
                    <circle
                        ...
                        cy="389"
                        r="332"
                        filter={borderGlow ? "url(#sofGlow)" : undefined}
                    />
                </g>
                <g id="s">
                    <path
                        id="s19"
                        fill={boardColorLight}
                        className={getSegmentClassNames("19")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_19))
                        }
                    ...
                    <path
                        id="s14"
                        fill={boardColorDark}
                        className={getSegmentClassNames("14")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_14))
                        }
                    ...
                    <path
                        id="s4"
                        fill={boardColorLight}
                        className={getSegmentClassNames("4")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_4))
                        }
                    ...
                    <path
                        id="s16"
                        fill={boardColorLight}
                        className={getSegmentClassNames("16")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_16))
                        }
                    ...
                    <path
                        id="s9"
                        fill={boardColorLight}
                        className={getSegmentClassNames("9")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_9))
                        }
                    ...
                    <path
                        id="s7"
                        fill={boardColorDark}
                        className={getSegmentClassNames("7")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_7))
                        }
                    ...
                    <path
                        id="s8"
                        fill={boardColorDark}
                        className={getSegmentClassNames("8")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_8))
                        }
                    ...
                    <path
                        id="s12"
                        fill={boardColorDark}
                        className={getSegmentClassNames("12")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_12))
                        }
                    ...
                    <path
                        id="s1"
                        fill={boardColorLight}
                        className={getSegmentClassNames("1")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_1))
                        }
                    ...
                    <path
                        id="s18"
                        fill={boardColorDark}
                        className={getSegmentClassNames("18")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_18))
                        }
                    ...
                    <path
                        id="s20"
                        fill={boardColorDark}
                        className={getSegmentClassNames("20")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_20))
                        }
                    ...
                    <path
                        id="s5"
                        fill={boardColorLight}
                        className={getSegmentClassNames("5")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_5))
                        }
                    ...
                    <path
                        id="s3"
                        fill={boardColorDark}
                        className={getSegmentClassNames("3")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_3))
                        }
                    ...
                    <path
                        id="s10"
                        fill={boardColorDark}
                        className={getSegmentClassNames("10")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_10))
                        }
                    ...
                    <path
                        id="s17"
                        fill={boardColorLight}
                        className={getSegmentClassNames("17")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_17))
                        }
                    ...
                    <path
                        id="s13"
                        fill={boardColorDark}
                        className={getSegmentClassNames("13")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_13))
                        }
                    ...
                    <path
                        id="s2"
                        fill={boardColorDark}
                        className={getSegmentClassNames("2")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_2))
                        }
                    ...
                    <path
                        id="s6"
                        fill={boardColorLight}
                        className={getSegmentClassNames("6")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_6))
                        }
                    ...
                    <path
                        id="s11"
                        fill={boardColorLight}
                        className={getSegmentClassNames("11")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_11))
                        }
                    ...
                    <path
                        id="s15"
                        fill={boardColorLight}
                        className={getSegmentClassNames("15")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.INNER_15))
                        }
                ...
                <g id="d">
                    <path
                        id="d2"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D2")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_2))
                        }
                    ...
                    <path
                        id="d17"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D17")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_17))
                        }
                    ...
                    <path
                        id="d15"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D15")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_15))
                        }
                    ...
                    <path
                        id="d6"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D6")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_6))
                        }
                    ...
                    <path
                        id="d14"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D14")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_14))
                        }
                    ...
                    <path
                        id="d10"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D10")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_10))
                        }
                    ...
                    <path
                        id="d11"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D11")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_11))
                        }
                    ...
                    <path
                        id="d19"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D19")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_19))
                        }
                    ...
                    <path
                        id="d8"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D8")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_8))
                        }
                    ...
                    <path
                        id="d16"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D16")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_16))
                        }
                    ...
                    <path
                        id="d7"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D7")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_7))
                        }
                    ...
                    <path
                        id="d3"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D3")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_3))
                        }
                    ...
                    <path
                        id="d1"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D1")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_1))
                        }
                    ...
                    <path
                        id="d20"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D20")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_20))
                        }
                    ...
                    <path
                        id="d18"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D18")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_18))
                        }
                    ...
                    <path
                        id="d5"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D5")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_5))
                        }
                    ...
                    <path
                        id="d12"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D12")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_12))
                        }
                    ...
                    <path
                        id="d9"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D9")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_9))
                        }
                    ...
                    <path
                        id="d4"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("D4")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_4))
                        }
                    ...
                    <path
                        id="d13"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("D13")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_13))
                        }
                ...
                <g id="t">
                    <path
                        id="t10"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T10")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_10))
                        }
                    ...
                    <path
                        id="t13"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T13")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_13))
                        }
                    ...
                    <path
                        id="t3"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T3")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_3))
                        }
                    ...
                    <path
                        id="t2"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T2")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_2))
                        }
                    ...
                    <path
                        id="t8"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T8")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_8))
                        }
                    ...
                    <path
                        id="t14"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T14")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_14))
                        }
                    ...
                    <path
                        id="t7"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T7")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_7))
                        }
                    ...
                    <path
                        id="t9"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T9")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_9))
                        }
                    ...
                    <path
                        id="t4"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T4")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_4))
                        }
                    ...
                    <path
                        id="t17"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T17")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_17))
                        }
                    ...
                    <path
                        id="t15"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T15")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_15))
                        }
                    ...
                    <path
                        id="t18"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T18")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_18))
                        }
                    ...
                    <path
                        id="t20"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T20")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_20))
                        }
                    ...
                    <path
                        id="t5"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T5")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_5))
                        }
                    ...
                    <path
                        id="t1"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T1")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_1))
                        }
                    ...
                    <path
                        id="t12"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("T12")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_12))
                        }
                    ...
                    <path
                        id="t6"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T6")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_6))
                        }
                    ...
                    <path
                        id="t11"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T11")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_11))
                        }
                    ...
                    <path
                        id="t19"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T19")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_19))
                        }
                    ...
                    <path
                        id="t16"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("T16")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.TRP_16))
                        }
                ...
                <g id="bull">
                    <path
                        id="Outer"
                        fill={boardColorAccent2}
                        className={getSegmentClassNames("BULL")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.BULL))
                        }
                    ...
                    <circle
                        id="Bull"
                        fill={boardColorAccent1}
                        className={getSegmentClassNames("DBULL")}
                        onClick={() =>
                            onSegmentClicked(CreateSegment(SegmentID.DBL_BULL))
                        }
                        cx="401.5"
                        cy="389"
                        r="13.7"
...
Dartboard.defaultProps = {
    boardColorDark: "#2a3236",
    boardColorLight: "#F7E9CD",
    boardColorAccent1: "#ED3737",
    boardColorAccent2: "#4F9962",
}